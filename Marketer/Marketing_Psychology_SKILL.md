...
**Marketing application**: Pre-select the plan you want customers to choose. For product tier selection, defaults are powerful. **Compliance note**: For marketing communications and subscriptions, opt-out (pre-ticked) consent is illegal in Australia under the Spam Act 2003 and under GDPR in the EU. Always use explicit opt-in for email/SMS marketing. Defaults work best for product choices, not consent.
